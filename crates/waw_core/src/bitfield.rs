use super::{Epoch, Index, StorageId};
...
impl PointerData {
    ...
    pub fn with_epoch(self, epoch: Epoch) -> Self {
        Self((self.0 & !EPOCH_MASK) + ((u64::from(epoch)) << EPOCH_OFFSET))
    }

    #[inline]
    pub const fn get_index(self) -> Index {
    ...
    #[inline]
    pub const fn get_storage_id(self) -> StorageId {
